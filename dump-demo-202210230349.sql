...
INSERT INTO `auth_group` VALUES (1,'api'),(2,'download_data'),(3,'logs'),(4,'售后'),(5,'财务'),(6,'跟单员'),(7,'销售');
...
--
-- Table structure for table `indent_Factory`
--

DROP TABLE IF EXISTS `indent_Factory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `indent_Factory` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `indent_Factory`
--

LOCK TABLES `indent_Factory` WRITE;
/*!40000 ALTER TABLE `indent_Factory` DISABLE KEYS */;
/*!40000 ALTER TABLE `indent_Factory` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `indent_customer`
--

DROP TABLE IF EXISTS `indent_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `indent_customer` (
  `id` int NOT NULL AUTO_INCREMENT,
  `number` int NOT NULL,
...
--
-- Dumping data for table `indent_customer`
--

LOCK TABLES `indent_customer` WRITE;
/*!40000 ALTER TABLE `indent_customer` DISABLE KEYS */;
/*!40000 ALTER TABLE `indent_customer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `indent_feedback`
--

DROP TABLE IF EXISTS `indent_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `indent_feedback` (
  `id` int NOT NULL AUTO_INCREMENT,
  `text` varchar(300) NOT NULL,
  `created` datetime(6) NOT NULL,
  `status` int NOT NULL,
  `customer_indent` varchar(20) NOT NULL,
  `employees` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `indent_feedback`
--

LOCK TABLES `indent_feedback` WRITE;
/*!40000 ALTER TABLE `indent_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `indent_feedback` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `sales_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sales_profile` (
  ...
  `base_pay` double DEFAULT NULL,
  `sex` int NOT NULL,
  `name_id` int DEFAULT NULL,
  `namex` varchar(30) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_id` (`name_id`),
  CONSTRAINT `sales_profile_name_id_245e90bc_fk_auth_user_id` FOREIGN KEY (`name_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `sales_profile` WRITE;
/*!40000 ALTER TABLE `sales_profile` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_profile` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sales_useractivity`
--

DROP TABLE IF EXISTS `sales_useractivity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sales_useractivity` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sales_useractivity`
--

LOCK TABLES `sales_useractivity` WRITE;
/*!40000 ALTER TABLE `sales_useractivity` DISABLE KEYS */;
/*!40000 ALTER TABLE `sales_useractivity` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-10-23  3:50:01
