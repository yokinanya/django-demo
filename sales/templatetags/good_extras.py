...
@register.inclusion_tag('goods/inclusions/_pagination.html', takes_context=True)
...
@register.inclusion_tag('goods/inclusions/_messages.html',takes_context=True)
...
@register.inclusion_tag('goods/inclusions/_weather.html',takes_context=True)
